...
const FilterModal: React.FC<FilterModalProps> = ({
  ...
  const categories = [
    { id: 'All', name: 'All Categories', icon: '📚', count: 8 },
    ...
    { id: 'Prompt Engineering', name: 'Prompt Engineering', icon: '🔗', count: 2 },
  ];
  ...
  const filters = [
    ...
    { id: 'Top Rated', name: 'Top Rated', icon: '🏆', description: 'Highest rated (4.5+)' },
  ];
